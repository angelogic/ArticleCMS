...
class Config(object):
    ...
    SQL_SERVER = os.environ.get(
        'SQL_SERVER') or 'chauserver1014.database.windows.net'
    SQL_DATABASE = os.environ.get('SQL_DATABASE') or 'chaudb'
    ...
    CLIENT_SECRET = "weU8Q~WNAgJFm5cTbdB-cwEpb-TlN_SVEVdApaFl"
